// Vector con colores (Tomados de https://gist.github.com/bobspace/2712980)
...
adornos[6].addEventListener("mouseenter", function( ) {
  adornos[6].classList.add("yellow");
  adornos[6].classList.remove("black");
});

adornos[6].addEventListener("mouseout", function( ) {
